...
| 2026-04-19 | v6-rank-blend-50-50 | Same feature set as the original best CatBoost and LightGBM models | 50/50 rank-average CatBoost + LightGBM ensemble | Rank average of submitted prediction files | N/A | 0.97212 | New best submission so far; rank averaging beat probability averaging |
| 2026-04-25 | v7-target-encoded-lightgbm | Frozen v1 numeric features plus leakage-safe target encodings for key categorical columns | LightGBM with fold-based target encoding | 5-fold OOF LightGBM with target-encoded categorical features | 0.97239 | 0.97257 | New best submission so far; target encoding finally beat the rank-blend ensemble |
| 2026-04-25 | v8-rank-blend-te-lgbm | Previous best rank blend combined with the new target-encoded LightGBM submission | 45% old rank-blend + 55% target-encoded LightGBM rank ensemble | Rank blend of saved submission files | N/A | 0.97260 | New best submission so far; small gain by giving slightly more weight to the target-encoded model |
| 2026-04-26 | v9-rank-blend-top-two-te | Rank blend of the two strongest target-encoding blend winners | 50/50 rank blend of the two top weighted target-encoding blend submissions | Rank blend of saved submission files | N/A | 0.97261 | Final best submission; tiny but real gain over 0.97260 |
